...
//
    ...
    private void createBooks(){
        createBooks.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
...
//                            Intent intent = new Intent(Write_tab3.this, MainActivity.class);
                          ...
                          //  startActivity(intent);
                           // startActivityForResult.launch(intent);
                            ...
                            Toast.makeText(Write_tab3.this, "Add Books Successfully", Toast.LENGTH_SHORT).show();
                        }
